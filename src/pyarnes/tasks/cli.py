...
TASKS: dict[str, list[str]] = {
    ...
    "lint:fix": [sys.executable, "-m", "ruff", "check", "--fix", "src", "tests"],
    "format": [sys.executable, "-m", "ruff", "format", "src", "tests"],
    "format:check": [sys.executable, "-m", "ruff", "format", "--check", "src", "tests"],
