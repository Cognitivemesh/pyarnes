...
> | **Tags** | safety, messages, guardrails |
...
> | **Supersedes** | — |
> | **Read after** | 10-hook-integration.md |
> | **Read before** | 12-transport.md |
> | **Not owned here** | external hook contract (see `10-hook-integration.md`); internal hook insertion points (see `09-loop-hooks.md`); evaluation semantics (see `15-bench-integrated-axes.md`); transport (see `12-transport.md`) |
> | **Last reviewed** | 2026-04-29 |

## Design Rationale

!!! tip "Compose guardrails as an ordered chain"
    Each guardrail is a single-purpose check. Compose them as a chain so the order of checks is explicit and debuggable.

> **Diagram:** [Sanitize → guardrail pipeline](diagrams/11-sanitize-guardrail.html).
