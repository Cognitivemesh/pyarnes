# pyarnes_swarm — Transport (Through Which Transport)
...
> | **Tags** | transport, networking, providers |
...
> | **Depends on** | 06-model-router.md |
> | **Extends** | 07-swarm-api.md |
> | **Supersedes** | — |
> | **Read after** | 11-message-safety.md |
> | **Read before** | 13-provider-config.md |
> | **Not owned here** | model selection (see `06-model-router.md`); provider config (see `13-provider-config.md`); secrets (see `14-secrets.md`); inter-agent message bus (see `05-message-bus.md`) — bus is for cross-process messaging, transport is for model-call plumbing |
