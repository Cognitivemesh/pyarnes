# pyarnes_swarm — Internal Loop Hooks
...
> | **Tags** | lifecycle, hooks, in-process |
...
> | **Extends** | — |
> | **Supersedes** | — |
> | **Read after** | 08-token-budget.md |
> | **Read before** | 10-hook-integration.md |
> | **Not owned here** | external Claude Code hooks — stdin JSON, exit codes, settings.json registration (see `10-hook-integration.md`); model routing (see `06-model-router.md`); evaluation (see `15-bench-integrated-axes.md`); error taxonomy definitions (see `01-package-structure.md`) |
